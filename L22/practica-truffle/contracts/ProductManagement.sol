...
contract ProductManagement {
    ...
    event PartCreated(bytes32 indexed part_hash, address indexed account);
    event ProductCreated(bytes32 indexed product_hash, address indexed account);
    ...
    function buildPart(string memory serial_number, string memory part_type, string memory creation_date) public returns (bytes32){
        ...
        emit PartCreated(part_hash, msg.sender);
    ...
    function buildProduct(
        ...
        bytes32[6] memory part_array) public returns (bytes32){
        ...
        emit ProductCreated(product_hash, msg.sender);
